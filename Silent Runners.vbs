...
'and with 32 & 64-bit versions of XP/Server 2003/Vista/7/8/Server 2008) 
'
'DO NOT REMOVE THIS HEADER!
'
'Copyright Andrew ARONOFF 26 April 2013, http://www.silentrunners.org/
...
'This script is divided into 34 sections.

'malware launch points:
' registry keys (1-15, 17, 20)
' INI/INF-files (18-19, 21)
' folders (22-23)
' enabled scheduled tasks (24)
' Winsock2 service provider DLLs (25)
' IE toolbars, explorer bars, extensions (26)
' started services (30)
' safe mode drivers & services (31)
' accessibility tools (32)
' keyboard driver filters (33)
' print monitors (34)

'hijack points:
' System/Group Policies (16)
' prefixes for IE URLs (27)
' misc IE points (28)
' HOSTS file (29)

'Output is suppressed if deemed normal unless the -all parameter is used 
'Section 21 is skipped unless the -supp/-all parameters are used or 
...
' 5. HKCU/HKLM/HKLM-WOW... Shell Extensions\Approved\
' 6. HKLM/HKLM-WOW... Explorer\DeviceNotificationCallbacks/SharedTaskScheduler/ShellExecuteHooks 
' 7. HKCU/HKLM/HKLM-WOW... ShellServiceObjectDelayLoad\
' 8. HKCU/HKLM/HKLM-WOW... Command Processor\AutoRun
...
' 9. HKLM... Authentication\Credential Provider Filters/Credential Providers/PLAP Providers 
'10. HKLM... Windows NT... Winlogon\Notify\ (subkey names/DLLName values <> OS-specific dictionary data) 
'11. HKLM/HKLM-WOW... Windows NT... Image File Execution Options ("Debugger" subkeys) 
'12. HKCU/HKLM... Policies... Startup/Shutdown, Logon/Logoff scripts (W2K/WXP/WVa/Wn7) 
'13. HKCU/HKLM PROTOCOLS\Filter & PROTOCOLS\Handler
'14. Context menu shell extensions
'15. HKCU/HKLM executable file type (bat/cmd/com/exe/hta/pif/scr)
'16. System/Group Policies
'17. Enabled Wallpaper & Screen Saver
'18. WIN.INI load/run, SYSTEM.INI shell/scrnsave.exe, WINSTART.BAT, IniFileMapping 
'19. AUTORUN.INF in root directory of local fixed disks 
'20. HKLM... Explorer\AutoplayHandlers\Handlers
'21. DESKTOP.INI in any local fixed disk directory (section skipped by default) 
'22. Startup Directories
'23. Windows Sidebar Gadgets
'24. Enabled Scheduled Tasks
'25. Winsock2 Service Provider DLLs
'26. Internet Explorer Toolbars, Explorer Bars, Extensions
'27. Internet Explorer URL Prefixes
'28. Misc. IE Hijack Points
'29. HOSTS file
'30. Started Services
'31. Safe Mode Drivers and Services
'32. Accessibility Tools
'33. Keyboard Driver Filters
'34. Print Monitors

'Configuration Detection Section

' Dim (121)
' FileSystemObject creation error (142)
' CScript/WScript (171)
' Dim (200)
' GetFileVersion(WinVer.exe) (VBScript 5.1) (335)
' WMI (389)
' OS version (419)
' bitness (517)
' WVa/Wn7 relaunch with admin rights (573) 
' command line arguments (617)
' supplementary search MsgBox (697)
' startup Popup (734)
' CreateTextFile error (761)
' output file header (799)
...
For Each oOS in colOS
 ...
 If InStr(strOSLong,"Windows 98") > 0 Then strOS = "W98"
 ...
 'id W98 SE
 If strOS = "W98" And oOS.OSType = "17" Then _
  strOSLong = "Windows 98 Second Edition"
...
'7 Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Run

'RunOnceEx: values at this key are *not* executed, but are displayed
' by the script. (The value for the "Title" name is used by Windows.)
' Setting the execution flag for this key to "2" would skip the sub-
' keys, setting to "1" would label sub-keys with "Execution Unlikely"
'
' HKCU\RunOnceEx launches *only* if HKLM\RunOnceEx is populated and it
' launches _after_ the HKLM value has exited
...
'Hive             HKCU - 0                     HKLM - 1
'
'Key      0   1   2   3   4   5   6   7    0   1   2   3   4   5   6   7 
'Index

'OS:
'W95     0,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  0,0 2,0 2,0 0,0 2,1 2,0 2,0 0,0 
'W98     0,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  0,0 2,0 2,0 2,0 2,1 2,0 2,0 0,0 
'WMe     2,1 2,1 2,0 2,0 2,1 0,0 0,0 0,0  2,1 2,1 2,0 2,0 2,1 2,0 2,0 0,0 
'NT4     0,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  0,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0 
'W2K     2,1 2,1 2,1 0,0 2,1 0,0 0,0 0,0  2,1 2,1 2,1 0,0 2,1 0,0 0,0 0,0 
'WXP     2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0 
'WXP64   2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 2,0 
'WS2K3   2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0 
'WS2K364 2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 2,0 
'WVa     2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0 
'WVa64   2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 2,0 
'Wn7     2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0 
'Wn764   2,0 2,0 2,0 0,0 2,1 0,0 0,0 0,0  2,0 2,0 2,0 0,0 2,1 0,0 0,0 2,0 
...
If strOs = "WXP" Or strOS = "WVA" Or strOS = "WN7" Then
 ...
 'for 64-bit OS, enable HKLM\SOFTWARE\WOW6432Node...Run
 If intBits = 64 Then arRegFlag(1,7,0) = 2  'HKLM|WOW6432Mode,Run = no-warn
...
ReDim arAllowedCLSID(4,1)

'Offline Files 
arAllowedCLSID(0,0) = "{750fdf0e-2a26-11d1-a3ea-080036587f03}"
arAllowedCLSID(0,1) = "cscui.dll"

'Enhanced Storage Icon Overlay Handler Class
arAllowedCLSID(1,0) = "{D9144DCD-E998-4ECA-AB6A-DCD83CCBA16D}"
arAllowedCLSID(1,1) = "EhStorShell.dll"

arAllowedCLSID(2,0) = "{4E77131D-3629-431c-9818-C5679DC83E81}" 
arAllowedCLSID(2,1) = "cscui.dll"

arAllowedCLSID(3,0) = "{08244EE6-92F0-47f2-9FC9-929BAA2E7235}" 
arAllowedCLSID(3,1) = "ntshrui.dll"

arAllowedCLSID(4,0) = "{7D688A77-C613-11D0-999B-00C04FD655E1}"
arAllowedCLSID(4,1) = "shell32.dll"
       ...
       If strIPSDLL <> "" Then
        ...
        For k = 0 To UBound(arAllowedCLSID,1)
         ...
         If Not flagShowAll And LCase(strCLSID) = LCase(arAllowedCLSID(k,0)) And _ 
          ...
          CoName(IDExe(strIPSDLL)) = MS Then
...
For i = ctrLow To UBound(arExpSubKeys)

 strSubTitle = SOCA("HKLM" & BS & arExpSubKeys(i) & BS)

 'set up allowed CLSID's & IPS names for each sub-key
 If InStr(LCase(arExpSubKeys(i)),"devicenotificationcallbacks") > 0 Then

  ReDim arAllowedCLSID(0,1)
  arAllowedCLSID(0,0) = "{8E25992B-373E-486E-80E5-BD23AE417E66}"
  arAllowedCLSID(0,1) = "SyncCenter.dll"

 ElseIf InStr(LCase(arExpSubKeys(i)),"sharedtaskscheduler") > 0 Then
 ...
 ElseIf InStr(LCase(arExpSubKeys(i)),"shellexecutehooks") > 0 Then
 ...
 oReg.EnumValues HKLM, arExpSubKeys(i), arNames, arType 
 ...
 If IsArray(arNames) Then
  ...
  For Each strName In arNames
   ...
   CLSIDLocTitle HKLM, arExpSubKeys(i), strName, strLocTitle
...
arSSODL(7,0) = "{AAA288BA-9A4C-45B0-95D7-94D524869DB5}" : arSSODL(7,1) = "WPDShServiceObj.dll" 
...
If strOS <> "W98" And strOS <> "WME" Then
 ...
 If strOS = "NT4" Or strOS = "W2K" Or strOS = "WXP" Then
  ...
  If strSubTitle = "" Then RegDataChk_v2 HKLM, strKey, "Auto", "1", "", False 
 ...
 If intErrNum = 0 And strValue <> "" Then
  ...
  For Each strVal In arValues
   ...
   If Not flagFound Then
    ...
    If strOut = "" Then  'if this is 1st unallowed value
     strOut = IWarn & "(" & DQ & Trim(strVal) & DQ & CoName(IDExe(strVal)) 
     flagIWarn = True
    Else  'not the 1st unallowed value
     strOut = strOut & ", " & DQ & Trim(strVal) & DQ & CoName(IDExe(strVal)) 
    End If
...
'#9. HKLM... Authentication\Credential Provider Filters/Credential Providers/
...
'#10. HKLM... Windows NT... Winlogon\Notify\ subkey DLLName values
  ...
  If IsArray(arSubKeys) Then
   ...
   For Each strSubKey in arSubKeys
    ...
    If LCase(strSubKey) <> LCase("Your Image File Name Here without a path") Or _
     ...
     Else  'Debugger value doesn't exist
...
'22 x 3 Handler array: handler title, CLSID value, CLSID\InProcServer32 default value 
        ...
        For flagWOWCLSID = 0 To 1
         ...
         If strIPSDLL <> "" Then
          ...
          For Each strAllowedDlls In arAllowedDlls
           ...
           'if allowed and CoName = MS and HKLM, toggle allowed flag
...
'  arMSSvc(110,0) = "" : arMSSvc(110,1) = "svchost.exe" : arMSSvc(110,2) = ".dll"
...
'  arMSSvc(70,0) = "" : arMSSvc(70,1) = "svchost.exe" : arMSSvc(70,2) = ".dll"
 ...
 ElseIf strOS = "WVA" Then
  ...
  arMSSvc(77,0) = "SstpSvc" : arMSSvc(77,1) = "svchost.exe" : arMSSvc(77,2) = "sstpsvc.dll" 
  arMSSvc(78,0) = "MSDTC" : arMSSvc(78,1) = "msdtc.exe" : arMSSvc(78,2) = ""
  arMSSvc(79,0) = "Browser" : arMSSvc(79,1) = "svchost.exe" : arMSSvc(79,2) = "browser.dll"
  arMSSvc(80,0) = "FontCache" : arMSSvc(80,1) = "svchost.exe" : arMSSvc(80,2) = "FntCache.dll"
  arMSSvc(81,0) = "stisvc" : arMSSvc(81,1) = "svchost.exe" : arMSSvc(81,2) = "wiaservc.dll"
  arMSSvc(82,0) = "KeyIso" : arMSSvc(82,1) = "lsass.exe" : arMSSvc(82,2) = ""
  arMSSvc(83,0) = "EapHost" : arMSSvc(83,1) = "svchost.exe" : arMSSvc(83,2) = "eapsvc.dll"
  arMSSvc(84,0) = "Wlansvc" : arMSSvc(84,1) = "svchost.exe" : arMSSvc(84,2) = "wlansvc.dll"
  arMSSvc(85,0) = "BthServ" : arMSSvc(85,1) = "svchost.exe" : arMSSvc(85,2) = "bthserv.dll"
  arMSSvc(86,0) = "Irmon" : arMSSvc(86,1) = "svchost.exe" : arMSSvc(86,2) = "irmon.dll"
  arMSSvc(87,0) = "wudfsvc" : arMSSvc(87,1) = "svchost.exe" : arMSSvc(87,2) = "WUDFSvc.dll"
  arMSSvc(88,0) = "WMPNetworkSvc" : arMSSvc(88,1) = "wmpnetwk.exe" : arMSSvc(88,2) = ""
  arMSSvc(89,0) = "WcesComm" : arMSSvc(89,1) = "svchost.exe" : arMSSvc(89,2) = "wcescomm.dll"
  arMSSvc(90,0) = "hidserv" : arMSSvc(90,1) = "svchost.exe" : arMSSvc(90,2) = "hidserv.dll"
  arMSSvc(91,0) = "napagent" : arMSSvc(91,1) = "svchost.exe" : arMSSvc(91,2) = "qagentRT.dll"
  arMSSvc(92,0) = "wmiApSrv" : arMSSvc(92,1) = "wmiApSrv.exe" : arMSSvc(92,2) = ""
  arMSSvc(93,0) = "SCardSvr" : arMSSvc(93,1) = "svchost.exe" : arMSSvc(93,2) = "SCardSvr.dll"
  arMSSvc(94,0) = "Wecsvc" : arMSSvc(94,1) = "svchost.exe" : arMSSvc(94,2) = "Wecsvc.dll"
  arMSSvc(95,0) = "dot3svc" : arMSSvc(95,1) = "svchost.exe" : arMSSvc(95,2) = "dot3svc.dll"
  arMSSvc(96,0) = "SessionEnv" : arMSSvc(96,1) = "svchost.exe" : arMSSvc(96,2) = "SessEnv.dll"
  arMSSvc(97,0) = "WPCSvc" : arMSSvc(97,1) = "svchost.exe" : arMSSvc(97,2) = "WPCSvc.dll"
  arMSSvc(98,0) = "vds" : arMSSvc(98,1) = "vds.exe" : arMSSvc(98,2) = ""
  arMSSvc(99,0) = "UI0Detect" : arMSSvc(99,1) = "UI0Detect.exe" : arMSSvc(99,2) = ""
  arMSSvc(100,0) = "QWAVE" : arMSSvc(100,1) = "svchost.exe" : arMSSvc(100,2) = "qwave.dll"
  arMSSvc(101,0) = "hkmsvc" : arMSSvc(101,1) = "svchost.exe" : arMSSvc(101,2) = "kmsvc.dll"
  arMSSvc(102,0) = "WinRM" : arMSSvc(102,1) = "svchost.exe" : arMSSvc(102,2) = "WsmSvc.dll"
  arMSSvc(103,0) = "p2pimsvc" : arMSSvc(103,1) = "svchost.exe" : arMSSvc(103,2) = "p2psvc.dll"
  arMSSvc(104,0) = "RasAuto" : arMSSvc(104,1) = "svchost.exe" : arMSSvc(104,2) = "rasauto.dll"
  arMSSvc(105,0) = "p2psvc" : arMSSvc(105,1) = "svchost.exe" : arMSSvc(105,2) = "p2psvc.dll"
  arMSSvc(106,0) = "PerfHost" : arMSSvc(106,1) = "perfhost.exe" : arMSSvc(106,2) = ""
  arMSSvc(107,0) = "SNMPTRAP" : arMSSvc(107,1) = "snmptrap.exe" : arMSSvc(107,2) = ""
  arMSSvc(108,0) = "pla" : arMSSvc(108,1) = "svchost.exe" : arMSSvc(108,2) = "pla.dll"
  arMSSvc(109,0) = "ehstart" : arMSSvc(109,1) = "svchost.exe" : arMSSvc(109,2) = "ehstart.dll"
  arMSSvc(110,0) = "RpcLocator" : arMSSvc(110,1) = "locator.exe" : arMSSvc(110,2) = ""
  arMSSvc(111,0) = "lltdsvc" : arMSSvc(111,1) = "svchost.exe" : arMSSvc(111,2) = "lltdsvc.dll"
  arMSSvc(112,0) = "Netlogon" : arMSSvc(112,1) = "lsass.exe" : arMSSvc(112,2) = ""
  arMSSvc(113,0) = "wercplsupport" : arMSSvc(113,1) = "svchost.exe" : arMSSvc(113,2) = "wercplsupport.dll"
  arMSSvc(114,0) = "CertPropSvc" : arMSSvc(114,1) = "svchost.exe" : arMSSvc(114,2) = "certprop.dll"
  arMSSvc(115,0) = "PNRPsvc" : arMSSvc(115,1) = "svchost.exe" : arMSSvc(115,2) = "p2psvc.dll"
  arMSSvc(116,0) = "RemoteRegistry" : arMSSvc(116,1) = "svchost.exe" : arMSSvc(116,2) = "regsvc.dll"
  arMSSvc(117,0) = "DFSR" : arMSSvc(117,1) = "DFSR.exe" : arMSSvc(117,2) = ""
  arMSSvc(118,0) = "SDRSVC" : arMSSvc(118,1) = "svchost.exe" : arMSSvc(118,2) = "SDRSVC.dll"
  arMSSvc(119,0) = "ALG" : arMSSvc(119,1) = "alg.exe" : arMSSvc(119,2) = ""
  arMSSvc(120,0) = "SLUINotify" : arMSSvc(120,1) = "svchost.exe" : arMSSvc(120,2) = "SLUINotify.dll"
  arMSSvc(121,0) = "ehSched" : arMSSvc(121,1) = "ehsched.exe" : arMSSvc(121,2) = ""
  arMSSvc(122,0) = "PNRPAutoReg" : arMSSvc(122,1) = "svchost.exe" : arMSSvc(122,2) = "p2psvc.dll"
  arMSSvc(123,0) = "ehRecvr" : arMSSvc(123,1) = "ehRecvr.exe" : arMSSvc(123,2) = ""
  arMSSvc(124,0) = "WdiServiceHost" : arMSSvc(124,1) = "svchost.exe" : arMSSvc(124,2) = "wdi.dll"
  arMSSvc(125,0) = "MSiSCSI" : arMSSvc(125,1) = "svchost.exe" : arMSSvc(125,2) = "iscsiexe.dll"
  arMSSvc(126,0) = "TBS" : arMSSvc(126,1) = "svchost.exe" : arMSSvc(126,2) = "tbssvc.dll"
  arMSSvc(127,0) = "SCPolicySvc" : arMSSvc(127,1) = "svchost.exe" : arMSSvc(127,2) = "certprop.dll"
  arMSSvc(128,0) = "WcsPlugInService" : arMSSvc(128,1) = "svchost.exe" : arMSSvc(128,2) = "WcsPlugInService.dll"
  arMSSvc(129,0) = "wcncsvc" : arMSSvc(129,1) = "svchost.exe" : arMSSvc(129,2) = "wcncsvc.dll"
  arMSSvc(130,0) = "IPBusEnum" : arMSSvc(130,1) = "svchost.exe" : arMSSvc(130,2) = "ipbusenum.dll"
  arMSSvc(131,0) = "idsvc" : arMSSvc(131,1) = "infocard.exe" : arMSSvc(131,2) = ""

'  arMSSvc(132,0) = "" : arMSSvc(132,1) = "svchost.exe" : arMSSvc(132,2) = ".dll"


ElseIf strOS = "WN7" Then  'WN7, WS2K8 R2, WN8 
  ...
  If strOSSS = "WN8" Then
   arMSSvc(47,2) = "AudioEndpointBuilder.dll" 
  End If
...
'  arMSSvc(175,0) = "" : arMSSvc(175,1) = "svchost.exe" : arMSSvc(175,2) = ".dll"
   ...
   For Each strSubKey In arSubKeys
    ...
    If LCase(Trim(strName)) = LCase(Trim(strSubKey)) Then
     ...
     oFN.WriteLine "Description = " & strValue1 & vbCRLF &_
      strWarn & "StartExe = " & strValue2 & CoName(IDExe(strValue2)) 
